...
class Navbar extends React.Component{
  ...
  setSearchName(){
    this.props.setName(this.inp.value)
  }
            ...
            <nav className="navbar navbar-expand-sm bg-light">
                 ...
                 <ul className="navbar-nav">
                  ...
                  <div className="form-group form-inline">
                    <input type="text" ref={el=>this.inp=el} className="form-control" placeholder="Search Users"/>
                    &nbsp;&nbsp;
                    <button onClick={this.setSearchName}  className="btn btn-primary">Search</button>
                  </div>
            </nav>
        );
  }
...
class Users extends React.Component{
    ...
    render(){
      ...
      let searchUser=[<div className="row">
                        <div className="col-sm-7 ">
                            <h5>Search a user using search box and hit search</h5>
                        </div>
                </div>];
